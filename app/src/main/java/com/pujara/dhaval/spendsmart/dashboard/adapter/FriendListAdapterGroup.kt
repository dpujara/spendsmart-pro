...
class FriendListAdapterGroup(private var friendList: MutableList<FriendBalance>) : RecyclerView.Adapter<FriendListAdapterGroup.CustomViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        holder.view.setOnClickListener {
            d("data",friendList[position].toString())
        }
    }
